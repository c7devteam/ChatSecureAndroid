 ...
 * the License.
 */
package info.guardianproject.otr.app.im.plugin.xmppcube7;
...
public class XmppCube7Plugin extends Service implements ImPlugin {
    ...
    public Map getProviderConfig() {
        ...
        config.put(ImConfigNames.PROTOCOL_NAME, "XMPP(Cube7)");
