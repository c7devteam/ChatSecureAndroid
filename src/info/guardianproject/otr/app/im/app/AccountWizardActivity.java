...
public class AccountWizardActivity extends ThemeableActivity implements
    ...
    private static final String CUBE7_ACCOUNT = "cube7_account";
    ...
    private void buildAccountList() {
        ...
        if (ImApp.IS_CUBE7_ONLY) {
            mAccountList = new String[1][3];
            mAccountList[0][0] = "Cube7";
            mAccountList[0][1] = "Add a cube7 account";
            mAccountList[0][2] = CUBE7_ACCOUNT;
        }
    ...
    public void showSetupAccountForm(String providerType, String username, String token,
        ...
        Log.i("test", "createAccount="+createAccount);
            ...
            wpf.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (TextUtils.equals(accountType, EXISTING_ACCOUNT)) {
                        ...
                        addGoogleAccount();
                    } else if (TextUtils.equals(accountType, CUBE7_ACCOUNT)) {
                        Log.i(TAG, "is cube7");
                        showSetupAccountForm(helper.getProviderNames().get(2), null, null, false,
                                helper.getProviderNames().get(2), true);
                    } else {
